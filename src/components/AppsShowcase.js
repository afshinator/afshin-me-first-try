...
return (
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="mb-20 text-center">
      <h1 className="mb-4 text-2xl font-medium text-gray-900 sm:text-3xl title-font">Afshin's App Playground</h1>
      <p className="mx-auto text-base leading-relaxed xl:w-2/4 lg:w-3/4">I'm going to be putting up a variety of cool mashups.</p>
    ...
    <button className="flex px-8 py-2 mx-auto mt-16 text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">Button</button>
  </div>
</section>
)
