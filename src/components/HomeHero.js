  ...
  return (
    <section className="container flex flex-col px-5 py-12 mx-auto">
      <div className="mx-auto lg:w-4/6">
        <div className="h-64 overflow-hidden rounded-lg cursor-pointer select-none">
          <motion.div
            style={{
              height: "260px",
        ...
        <div className="flex flex-col mt-10 sm:flex-row">
          <div className="text-center sm:w-1/3 sm:pr-8 sm:py-8">
            <motion.div
              ...
              style={{ margin: "0 auto" }}
              initial={{ opacity: 0 }}
              animate={{ scale: [3, 1], rotateY: [90, 0], opacity: 1 }}
              transition={{
                duration: 1.0,
                ease: "easeIn",
                type: "spring",
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <h2
                ...
                // animate={{ y:[-200, 0], x:[60,0], duration: 5.0 }}
              >
                Afshin Mokhtari
              </h2>
              <div
              ...
              >
                I'm a Software Engineer. These days my specialty is in Web apps
                with <strong>React-JS</strong> and mobile apps with React
                Native. I also have older experience with Ruby on Rails,
                Backbone JS, JQuery, and much more I've also been playing with
                TensorFlow, ...
              </motion.p>
            </div>
          </div>
